 ...
 * @author Deran
 */
public class VuelosCliente extends javax.swing.JFrame {

    Vuelo vuelo = Vuelo.getInstance();
    /**
     * Creates new form VerVuelos
     */
    public VuelosCliente() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Mostrar vuelos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VuelosCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VuelosCliente().setVisible(true);
            }
        });
    }
